...
interface ERC20
{
    ...
    function transferLOT(address emisor, address recipient, uint256 amount) external returns(bool);
...
contract ERC20Basic is ERC20
{
    ...
    string public constant name = "ERC20ADOTEL";
    string public constant symbol = "ORL";
    ...
    function transferLOT(address emisor, address recipient, uint256 _numTokens) public override returns(bool){
